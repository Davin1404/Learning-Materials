...
开头段: 语境+文本(作者，作品名称，文本类型)，文本内容概述，主题+平台，受众，语境，交流目的，传播效果等+分析角度(一个聚焦点)  
...
3. 新闻结构（**等感染读者**）
   1. 倒金字塔
      1. 重要 $\to$ 次要，
      2. 以一个“新闻提要”的方式呈现在新闻的最前端，种方式有助于媒体编辑下标题，亦有助于阅听人快速清楚新闻重点
      3. 在导语中写一个新闻事件中最有新闻价值的部分（新闻价值通俗来讲就是新闻中那些最突出，最新奇，最能吸引受众的部分)
      4. 在报道主体中按照事件各个要素的重要程度，依次递减写下来，最后面的是最不重要的。同时注意，一个段落只写一个事件要素，不能一段到底
   2. 折中式（新华体）
      1. 新闻中最重要的讯息仍然在导言中呈现，接著，**则依新闻的时间性或逻辑性叙述**
      2. 先把事件中最重要的部分在导语中简明地体现出来
      3. 在第二段进一步具体阐述导语中的这个重要部分，形成支持，不至于使受众在接受时形成心理落差
      4. 按照事件发展的时间顺序把“故事”讲下来
   3. 正金字塔式
      1. 次要 $\to$ 重要
      2. 此种写作方式刚好与「倒金字塔式」相反，是以时间发生顺序作为行文结构的写作方式，依序分别是引言、过程、结果，采渐入高潮的方式，将新闻重点摆在文末，一般多用于特写
   4. 平铺直叙
      1. 顾名思义，此种写作方式就是注重行文的起、承、转、合，力求文字的流畅精准。
>现在有一种叫做“华尔街日报体”的格式很流行，这个格式的主要特点就是在文首特写新闻事件中的一个“镜头”，一般是以一个人的言行为主，从而引出整个的新闻报道，比如央行关于房贷要加息的消息，新闻报道就可以从一个普通市民的住房贷款行为写起，比较能贴近实际，贴近群众，贴近生活
...
## 结构分析一般方法
为了（...），作者采用了（由浅入深，层层剥笋）的逻辑结构，使（...）。文本以（...）开始，以（...）结尾，正文以（...）层层推进，不仅（...），同时（...）。而文章标题（...）
